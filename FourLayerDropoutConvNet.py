...
class FourLayerDropoutConvNet(nn.Module):
  def __init__(self, p=0.2):
    """
    This class defines a Convolutional Neural Network consists of 2 conv layers and 2 fully connected layers
    to train for classification of MNIST
    Dropout is applied
